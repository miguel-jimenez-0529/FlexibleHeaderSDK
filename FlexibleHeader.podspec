...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FlexibleHeader.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Miguel/FlexibleHeader'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Miguel' => 'miguel.jimenez.0529@gmail.com' }
  s.source           = { :git => 'https://github.com/Miguel/FlexibleHeader.git', :tag => s.version.to_s }
